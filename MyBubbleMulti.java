...
public class MyBubbleMulti {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("............ Welcome to Bubble Parallel Processing Environment+++++++++");
        ...
        // Thread 1 - Bubble
        Sort s1 = new Sort(ds, "bubble");
        s1.setStart(0);
        s1.setEnd(mid);
        Thread t1 = new Thread(s1);

        // Thread 2 - Bubble
        Sort s2 = new Sort(ds, "bubble");
        s2.setStart(mid);
        s2.setEnd(size);
        ...
        Sort merger = new Sort(ds, "bubble");
        merger.setMid(mid);
        merger.merge();
